#!/bin/bash
# Train DiffusionPolicy (DinoV2 ViT-L/14 + Transformer backbone).
#
# Usage:
#   bash scripts/train_dp.sh DATA_PATH SAVE_PATH GPU [FEATURE_DIR]
#
# Examples:
#   # With precomputed DinoV2 features (fastest)
#   bash scripts/train_dp.sh data/easy_mode checkpoints/dp 1 data/vitl14_features
#
#   # Without precomputed features (on-the-fly, slower)
#   bash scripts/train_dp.sh data/easy_mode checkpoints/dp 1
#
#   # Single-task
#   bash scripts/train_dp.sh data/easy_mode/0 checkpoints/dp_0 1
#
# Environment variables (override defaults):
#   BATCH_SIZE=128  EPOCHS=300  LR=1e-4  NUM_WORKERS=8
#   EXP_NAME=dp  TRAIN_SUFFIX=_train  TEST_SUFFIX=_test
...
echo ""
echo "============================================================"
echo "  DiffusionPolicy  (DinoV2 ViT-L/14 + Transformer)"
echo "============================================================"
